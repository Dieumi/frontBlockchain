 ...
 * found in the LICENSE file at https://angular.io/license
 */
const r=n(3),s=n(2),o=n(13);var i;function a(t){const e=t.read("/package.json");if(null===e)throw new s.SchematicsException("Could not read package.json.");const n=e.toString(),o=r.parseJsonAst(n,r.JsonParseMode.Strict);if("object"!=o.kind)throw new s.SchematicsException("Invalid package.json. Was expecting an object");return o}!function(t){t.Default="dependencies",t.Dev="devDependencies",t.Peer="peerDependencies",t.Optional="optionalDependencies"}(i=e.NodeDependencyType||(e.NodeDependencyType={})),e.addPackageJsonDependency=function(t,e){const n=a(t),r=o.findPropertyInAstObject(n,e.type),s=t.beginUpdate("/package.json");if(r){if("object"===r.kind){const t=o.findPropertyInAstObject(r,e.name);if(t){if(e.overwrite){const{end:n,start:r}=t;s.remove(r.offset,n.offset-r.offset),s.insertRight(r.offset,JSON.stringify(e.version))}}else o.insertPropertyInAstObjectInOrder(s,r,e.name,e.version,4)}}else o.appendPropertyInAstObject(s,n,e.type,{[e.name]:e.version},2);t.commitUpdate(s)},e.getPackageJsonDependency=function(t,e){const n=a(t);let r=null;return[i.Default,i.Dev,i.Optional,i.Peer].forEach(t=>{if(null!==r)return;const s=o.findPropertyInAstObject(n,t);if(null!==s&&"object"===s.kind){const n=o.findPropertyInAstObject(s,e);if(null!==n&&"string"===n.kind){const s=n.value;r={type:t,name:e,version:s}}}}),r}},function(t,e,n){"use strict";Object.defineProperty(e,"__esModule",{value:!0});
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
